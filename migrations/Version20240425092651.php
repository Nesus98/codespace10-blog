 ...
 */
final class Version20240425092651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entrada (id INT AUTO_INCREMENT NOT NULL, categoria_id INT NOT NULL, usuario_id INT NOT NULL, slug VARCHAR(255) NOT NULL, titulo VARCHAR(255) NOT NULL, fecha DATETIME NOT NULL, estado SMALLINT NOT NULL, resumen LONGTEXT NOT NULL, texto LONGTEXT DEFAULT NULL, entradas VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C949A274989D9B62 (slug), INDEX IDX_C949A2743397707A (categoria_id), INDEX IDX_C949A274DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
